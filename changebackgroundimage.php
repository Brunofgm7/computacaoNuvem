...
<h1 class="text-center" style="padding-bottom:1%">Change background image</h1>
        <div class="card" style="background-color:rgba(0,0,0,0.1)"> 
            <div class="card-body" >
                ...
                <div class="row">
                    ...
                    $sql = "SELECT * FROM backgroundimage";
                    if ($result = $db->query($sql)) {
                        while ($row = $result->fetch_assoc()) {
                            ?>
                            <div class="col-xxl-2 col-xl-4 col-md-6 col-sm-8 d-flex justify-content-center">
                                <label>
                                    <input type="radio" name="imagem" id="imagem" value="<?= $row["backgroundimage"] ?>">
                                    <img src="<?= $row["backgroundimage"] ?>" class="img_profile">
                                </label>                    
                            </div>
                            <?php
                        }
                    ...
                    <div class="form-group row pt-2">
                        <div class="col-md-12 text-center">
                            <input type="submit" name="changebackgroundimage" id="changebackgroundimage" class="btn btn-success" value="Change">
                        </div>
                    </div>
                </form>
        </div>
